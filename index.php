...
<html lang="en-us">
  <head>
    ...
    <title>Unity WebGL Player | BlackJack</title>
    ...
    <script src="TemplateData/web3config.js"></script>
  </head>
  <body>
    <div id="unity-container" class="unity-desktop">
      <canvas id="unity-canvas" width=1440 height=768></canvas>
      ...
      <div id="unity-footer">
        ...
        <div id="unity-build-title">BlackJack</div>
      </div>
    </div>
    <script>
